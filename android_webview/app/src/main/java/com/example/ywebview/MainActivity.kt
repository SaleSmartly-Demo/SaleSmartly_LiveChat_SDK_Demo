...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // 加载网址
        webView.loadUrl("https://faovoj.slinkchat.top/")
//        如果加载的页面设置了会重定向的链接，那么出现错误 "net::ERR_CLEARTEXT_NOT_PERMITTED",
    //    比如设置的是"https://www.google.com/" 但实际上是跳转到 "https://www.google.com.hk/"
